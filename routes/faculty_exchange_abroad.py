...
faculty_exchange_abroad_bp = Blueprint(
    "faculty_exchange_abroad",
    __name__,
    url_prefix="/faculty-exchange-abroad"
)


@faculty_exchange_abroad_bp.route("/")
def index():

    module_key = "faculty_exchange_abroad"
    ...
    return render_template(
        "faculty_exchange_abroad/index.html",
