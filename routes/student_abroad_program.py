...
student_abroad_program_bp = Blueprint(
    "student_abroad_program",
    __name__,
    url_prefix="/student-abroad-program"
)


@student_abroad_program_bp.route("/")
def index():

    module_key = "student_abroad_program"
    ...
    return render_template(
        "student_abroad_program/index.html",
